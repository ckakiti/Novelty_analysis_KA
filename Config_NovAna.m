...
video_xlen=520;%520;%512;%400
video_ywid=420;%420;%424;%480            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

fpm = 1500; %5040 %1800 %1500 %900 % frames per minute
fps = fpm./60;          % frames per second
ppc = 42/6.3; %123/23; %340/(2*30);   % pixels per cm   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
radius_cm = 8; %10 for tea obj %9 for MoSeq %8 default %5-8 nose  % Time spent around the obj radius (cm)   %%%%%%%%%%%%%
...
Dis_te_frame=10.*60.*fps+Dis_ts_frame; %10 %8

Ang_ts_frame=500;         % Time orient towards the obj start and end frame
Ang_te_frame=10.*60.*fps+Ang_ts_frame; %10 %8
