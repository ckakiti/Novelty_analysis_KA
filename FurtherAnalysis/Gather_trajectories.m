...
sessionNames = {'H1' 'H2' 'N1' 'N2'};

fig1 = figure(1);
%suptitle([currMouse(1:2), ' ' currMouse(4:end)])
suptitle(currMouse)
set(fig1, 'Position', [200 1 1500 500]);%[200 1 1500 700]); %[200 1 1500 500]);
hold on

for i = 1:length(trajs)
    image = imread(trajs(i).name);
    imageCropped = imcrop(image, [500 150 950 1050]);%[500 200 950 950]);%[550 150 1150 950]);
