...
%suptitle(currMouse)
set(fig1, 'Position', [200 1 1500 500]);%[200 1 1500 800]);
hold on

for i = 2:3%1:length(trajs)
    image = imread(trajs(i).name);
    imageCropped = imcrop(image, [500 200 950 950]); %[550 150 1150 950]);
