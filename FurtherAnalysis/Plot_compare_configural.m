...
timeDistNorm = zeros(size(timeStat_all,3),size(timeStat_all,1));

for mouseiter = 1:size(timeStat_all,3)
    currNorm = timeStat_all(:,1,mouseiter)./sum(timeStat_all(:,1:4,mouseiter),2);
