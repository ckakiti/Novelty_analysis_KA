...
whichMouse = 'Air';
whichDate  = '210509';
whichSession = 'Hab2'; %Hab2 %N1 %R1(arm+delivery) %R2(consumption)
whichFile = 1;
...
%% (2) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
FP_file = dir('*FP_tone2.mat'); % generated by FPdat_import.m
%load('MoSeqFP.mat');     % generated by FPDataTransfer.py
load(FP_file(1).name)
...
title_dFF_1     = 'GCaMP signal';
xlabel_dFF_1    = 'time of tone (ms)';
xlabel_raster_1 = 'time - tone (s)';
...
if(0)
    ...
    saveas(fig3, ['FP_raster_tdTom_' whichMosue '_' whichSession '.tif'])
    close all
end
