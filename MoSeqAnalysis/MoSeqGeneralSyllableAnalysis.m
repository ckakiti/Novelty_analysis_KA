...
%   General Syllable Usage (sorted by usage)
%   General Syllable Usage (top 20 syllables)
%   Cumulative Syllable Usage
%   Syllable Usage (comparing across conditions)
%   
...
%% plot general syllable usage (sorted by usage)
...
%% syllable usage compared across conditions
...
%% syllable usage compared across conditions, sorted by stimulus novelty enrichment
close all
